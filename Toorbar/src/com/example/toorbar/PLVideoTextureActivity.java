...
public class PLVideoTextureActivity extends VideoPlayerBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mVideoPath = intent.getStringExtra("url");

		// If you want to fix display orientation such as landscape, you can use
		...
		// 1 -> hw codec enable, 0 -> disable [recommended]
		int codec = getIntent().getIntExtra("mediaCodec",
				AVOptions.MEDIA_CODEC_SW_DECODE);
		setOptions(codec);
	...
	private void showToastTips(final String tips) {
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				mToast = Toast.makeText(PLVideoTextureActivity.this, tips,
						Toast.LENGTH_SHORT);
				mToast.show();
			}
		});
	...
	private void sendReconnectMessage() {
		...
		mHandler.sendMessageDelayed(
				mHandler.obtainMessage(MESSAGE_ID_RECONNECTING), 500);
	}
